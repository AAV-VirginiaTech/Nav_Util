...
public class Main extends Application {
    ...
    Stage window;
    TableView<sample.Product> table;
    ...
    public void start(Stage primaryStage) throws Exception {
        ...
        //Name column
        TableColumn<sample.Product, String> labelColumn = new TableColumn<>("Label");
        labelColumn.setMinWidth(100);
        labelColumn.setCellValueFactory(new PropertyValueFactory<>("label"));

        //Price column
        TableColumn<sample.Product, Double> latColumn = new TableColumn<>("Lat");
        latColumn.setMinWidth(100);
        latColumn.setCellValueFactory(new PropertyValueFactory<>("lat"));

        //Quantity column
        TableColumn<sample.Product, String> longitudeColumn = new TableColumn<>("Long");
        longitudeColumn.setMinWidth(100);
        longitudeColumn.setCellValueFactory(new PropertyValueFactory<>("long"));

        //Height column
        TableColumn<sample.Product, String> heightColumn = new TableColumn<>("Height");
        heightColumn.setMinWidth(100);
        heightColumn.setCellValueFactory(new PropertyValueFactory<>("height"));

        //Type clumn
        TableColumn<sample.Product, String> typeColumn = new TableColumn<>("Point Type");
    ...
    public void deleteButtonClicked(){
        ObservableList<sample.Product> productSelected, allProducts;
    ...
    public ObservableList<sample.Product> getProduct(){
        ObservableList<sample.Product> products = FXCollections.observableArrayList();
        products.add(new sample.Product("Laptop", 859.00, 20));
        products.add(new sample.Product("Bouncy Ball", 2.49, 198));
        products.add(new sample.Product("Toilet", 99.00, 74));
        products.add(new sample.Product("The Notebook DVD", 19.99, 12));
        products.add(new sample.Product("Corn", 1.49, 856));
        return products;
    }
